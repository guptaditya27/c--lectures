...
class Complex
{
    ...
    public:
        ...
        Complex operator -(Complex);
        Complex operator -();// fn overloading in optr overloading
...
int main()
{
    ...
    //c3=c1.operator+(c2);{operator overloading}
    /* c1 is caller object jisne apne add mtd ko call kiya usme c2 as an argument
    pass huaa and jo add ne return kiya woh c3 mein store huya */
    c3.showdata();
    //cout<<endl;
    c4=c1-c2;     //c4=c1.sub(c1,c2);
    c4.showdata();
    //c5.multiply(c1,c2);
    //c5.showdata();
    // cout object ka operator operation
    //int k=1;
    //cout<<k<<endl;
    //cout.operator<<(k);
